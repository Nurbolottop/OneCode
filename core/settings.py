...
# JAZZMIN
JAZZMIN_SETTINGS = {
    "site_title": "OneCode",  # Заголовок админ-панели
    "site_header": "OneCode",  # Заголовок на экране входа
    "site_brand": "OneCode",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в OneCode",  # Приветственное сообщение
    "site_title": "OneCode",  # Заголовок админ-панели
    "site_header": "OneCode",  # Заголовок на экране входа
    "site_brand": "OneCode",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в OneCode",  # Приветственное сообщение
